...
template <typename ParentTypeA, typename ParentTypeB>
Matrix<3, 1, typename ParentTypeA::DType> CrossProduct(
    const MatrixBase<ParentTypeA, 3, 1, typename ParentTypeA::DType> &a,
    const MatrixBase<ParentTypeB, 3, 1, typename ParentTypeA::DType> &b)
{
    return {
        a(1) * b(2) - b(1) * a(2),
        a(2) * b(0) - b(2) * a(0),
